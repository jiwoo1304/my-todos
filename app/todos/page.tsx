...
const Todos = () => {
  ...
  return (
    <div>
      <div className="w-full flex flex-col items-center bg-gradient-to-r from-blue-500 to-purple-500 text-white">
        {/* modal */}
        {showModal && (
          <AddTodoModal
            task={task}
              ...
              {tasks.map((task) => (
                ...
                >
                  <div
                    ...
                    className={`h-12 relative hover:ring-4 rounded-lg sm:w-full pl-16 py-4 cursor-pointer text-white text-[1.1rem]`}
                  >
